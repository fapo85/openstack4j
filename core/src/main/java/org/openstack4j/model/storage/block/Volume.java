...
public interface Volume extends ModelEntity, Buildable<VolumeBuilder> {
     ...
     */
    enum Status {
        AVAILABLE, ATTACHING, BACKING_UP, CREATING, DELETING, DOWNLOADING, UPLOADING, ERROR, ERROR_DELETING, ERROR_RESTORING, IN_USE, RESTORING_BACKUP, DETACHING, RESERVED, UNRECOGNIZED;
